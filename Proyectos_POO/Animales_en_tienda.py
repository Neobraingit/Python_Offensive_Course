...
if __name__ == '__main__':
    ...
    gato = Animal('Pelusa', 'Gato')
    perro = Animal('Frodo', 'Perro')
    ...
    print (f'[+] Mostrando los animales una vez estos han sido alimentados')
    
    tienda.alimentar_animales()
    tienda.mostrar_animales()
    
    tienda.vender_animal('Pelusa')
    
    print (f'[+] Mostrando los animales una vez Pelusa ha sido vendida')
    tienda.mostrar_animales()
